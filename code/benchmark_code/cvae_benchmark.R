...
mcar_10i <- read.csv('../../data/MCAR/mcar10/cvae_mcar_10.csv', row.names = 1)
mcar_25i <- read.csv('../../data/MCAR/mcar25/cvae_mcar_25.csv', row.names = 1)
mcar_40i <- read.csv('../../data/MCAR/mcar40/cvae_mcar_40.csv', row.names = 1)
mnar_30i <- read.csv('../../data/MNAR/mnar30/cvae_mnar_30.csv', row.names = 1)
mnar_50i <- read.csv('../../data/MNAR/mnar50/cvae_mnar_50.csv', row.names = 1)
mcar_pathi <- read.csv('../../data/path/mcar_40/cvae_path_mcar.csv', row.names = 1)
mnar_pathi <- read.csv('../../data/path/mnar_50/cvae_path_mnar.csv', row.names = 1)
...
write.csv(results_df, '../../outputs/cvae/rmse_cor.csv')
...
ggsave('../../outputs/cvae/group_plots.png', group_plots,
       width = 15, height = 7)
