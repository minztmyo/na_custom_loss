...
mcar_10i <- read.csv('../../data/MCAR/mcar10/missForest_mcar_10.csv', row.names = 1)
mcar_25i <- read.csv('../../data/MCAR/mcar25/missForest_mcar_25.csv', row.names = 1)
mcar_40i <- read.csv('../../data/MCAR/mcar40/missForest_mcar_40.csv', row.names = 1)
mnar_30i <- read.csv('../../data/MNAR/mnar30/missForest_mnar_30.csv', row.names = 1)
mnar_50i <- read.csv('../../data/MNAR/mnar50/missForest_mnar_50.csv', row.names = 1)
mcar_pathi <- read.csv('../../data/path/mcar_40/missForest_path_mcar.csv', row.names = 1)
mnar_pathi <- read.csv('../../data/path/mnar_50/missForest_path_mnar.csv', row.names = 1)
...
# 
# mcar_10i <- scale(mcar_10i)
# mcar_25i <- scale(mcar_25i)
# mcar_40i <- scale(mcar_40i)
# mnar_30i <- scale(mnar_30i)
# mnar_50i <- scale(mnar_50i)
# mcar_pathi <- scale(mcar_pathi)
# mnar_pathi <- scale(mnar_pathi)
...
write.csv(results_df, '../../outputs/missforest/rmse_cor.csv')
...
ggsave('../../outputs/missforest/group_plots.png', group_plots,
       width = 15, height = 7)  
