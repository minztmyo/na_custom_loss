...
mcar_10i <- read.csv('../../data/MCAR/mcar10/ae_mcar_10.csv', row.names = 1)
mcar_25i <- read.csv('../../data/MCAR/mcar25/ae_mcar_25.csv', row.names = 1)
mcar_40i <- read.csv('../../data/MCAR/mcar40/ae_mcar_40.csv', row.names = 1)
mnar_30i <- read.csv('../../data/MNAR/mnar30/ae_mnar_30.csv', row.names = 1)
mnar_50i <- read.csv('../../data/MNAR/mnar50/ae_mnar_50.csv', row.names = 1)
...
write.csv(results_df, '../../outputs/autoencoder/rmse_cor.csv')
...
ggsave('../../outputs/autoencoder/scatter.png', scatter_plot,
       width = 10, height = 7)
