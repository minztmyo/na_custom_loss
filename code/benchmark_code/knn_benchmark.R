...
mcar_10i <- read.csv('../../data/MCAR/mcar10/knn_mcar_10.csv', row.names = 1)
mcar_25i <- read.csv('../../data/MCAR/mcar25/knn_mcar_25.csv', row.names = 1)
mcar_40i <- read.csv('../../data/MCAR/mcar40/knn_mcar_40.csv', row.names = 1)
mnar_30i <- read.csv('../../data/MNAR/mnar30/knn_mnar_30.csv', row.names = 1)
mnar_50i <- read.csv('../../data/MNAR/mnar50/knn_mnar_50.csv', row.names = 1)
mcar_pathi <- read.csv('../../data/path/mcar_40/knn_path_mcar.csv', row.names = 1)
mnar_pathi <- read.csv('../../data/path/mnar_50/knn_path_mnar.csv', row.names = 1)
...
write.csv(results_df, '../../outputs/knn/rmse_cor.csv')
...
ggsave('../../outputs/knn/group_plots.png', group_plots,
       width = 15, height = 7)  
