...
def na_autoencoder(x):
    ...
    encoded = k.layers.Dense(2, activation='relu')(input)
    decoded = k.layers.Dense(n_dims,activation='sigmoid')(encoded)
...
mcar_10i.to_csv( '../../data/MCAR/mcar10/ae_trans_activ_mcar_10.csv')
mcar_25i.to_csv( '../../data/MCAR/mcar25/ae_trans_activ_mcar_25.csv')
mcar_40i.to_csv(  '../../data/MCAR/mcar40/ae_trans_activ_mcar_40.csv')
mnar_30i.to_csv(  '../../data/MNAR/mnar30/ae_trans_activ_mnar_30.csv')
mnar_50i.to_csv(  '../../data/MNAR/mnar50/ae_trans_activ_mnar_50.csv')
mcar_pathi.to_csv(  '../../data/path/mcar_40/ae_trans_activ_path_mcar.csv')
mnar_pathi.to_csv( '../../data/path/mnar_50/ae_trans_activ_path_mnar.csv')
